...
export default class DetherJS {
  ...
  async init(connectOptions?: IEthersOptions, contractAddresses?: IContractAddresses) : Promise<void> {
  ...
  async addTeller(password: string, zoneAddress: string, tellerData: ITellerArgs) {
